...
| 3 | Pending rulings | **done (none)** | `docs/archive/untangling/DECISIONS_TO_MAKE.md`: "every item below is ruled by R-21 to R-59". The cold-read rulings R-168 to R-184 are applied (PR #10); R-185 is applied (PR #11). |
