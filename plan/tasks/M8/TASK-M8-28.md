...
## Acceptance tests
- `cargo xtask screenshot 04_windows` (Profiler; histogram cap marker at N_max) — screenshot against 04_windows.png's profiler; the histogram's cap marker sits at N_max (REQ-TOOL-098).
