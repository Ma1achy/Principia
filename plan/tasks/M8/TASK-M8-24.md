...
- `cargo test -p gui run_fields` — the Run window's field list equals the contract parameter names; defaults N_max = 64 and occupant = Heggie×KDK; T_horizon is clamped to [50, 200]; no field named tolerance (REQ-GUI-102).
