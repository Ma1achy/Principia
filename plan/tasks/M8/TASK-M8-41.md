...
## Deliverables
- `cargo xtask gate parity-non-metal` — runs the M4 parity suite on a Vulkan / D3D12 adapter and records the result.
...
## Acceptance tests
- `cargo xtask gate parity-non-metal` — the parity suite passes on a Vulkan or D3D12 adapter; recorded before Paper-2 survey results (REQ-VAL-099).
...
## Notes
- REQ-VAL-099 gates Paper 2, not the build (R-58): it's in the M8 gate as a recorded run.
