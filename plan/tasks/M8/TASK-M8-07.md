...
- **Milestone:** M8
- **Closes:** REQ-GUI-091, REQ-GUI-092, REQ-GUI-099
...
## Notes
- The scrubber's "refining · N%" needs a progress fraction in the snapshot; what it is a fraction of is not stated (raised as a gap for a REVIEW_QUEUE entry).
