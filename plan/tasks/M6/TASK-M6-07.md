...
- RQ-99 ruled: R-113, option (a) — REQ-DEC-036 (x₀ and J_D by central differences) moved to M5 (TASK-M5-04); this task keeps the error-fit tests (REQ-DEC-034, REQ-DEC-042) and the |det J_D| check.
