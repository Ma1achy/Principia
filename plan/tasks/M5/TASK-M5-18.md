...
- **Milestone:** M5
- **Closes:** REQ-REF-002, REQ-REF-003, REQ-REF-004, REQ-REF-005, REQ-REF-010, REQ-PAY-061, REQ-RENDER-051, REQ-RENDER-053, REQ-INT-072
...
- `cargo test -p kernel ensemble_entropy_sigma` — copy 0's offset is exactly zero; copy k's offset equals (Halton_k − ½) scaled to the footprint for k = 1..E; dd test 11: deep basin-interior pixel gives H = 0 and tiny σ²; boundary-straddling pixel gives H > 0 (REQ-INT-072).
