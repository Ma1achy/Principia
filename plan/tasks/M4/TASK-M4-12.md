...
- **Milestone:** M4
- **Closes:** REQ-RENDER-029, REQ-RENDER-034, REQ-RENDER-036, REQ-SCHED-008, REQ-VAL-058
...
## Notes
- Gap (see report): the spread-extrapolation `rate` is not defined, and REQ-VAL-058's "decided" needs a human ruling, not an implementer's choice.
