...
- **Milestone:** M3
- **Closes:** REQ-EVT-005, REQ-EVT-006, REQ-EVT-011, REQ-EVT-015, REQ-EVT-016, REQ-EVT-017, REQ-EVT-018, REQ-EVT-024
...
- Proposal: tau, provisional from the recorded gap and then set inside REQ-VAL-051's re-measured gap, with the gap distributions as evidence; the human confirms it at the M3 gate (REQ-EVT-024).
