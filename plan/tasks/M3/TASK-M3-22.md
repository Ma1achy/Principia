...
- `xtask screenshot live-march-views` — the |n|−1 view and the live effort heatmap on a real march (REQ-TOOL-132).
...
- `cargo xtask screenshot live-march-views` — on a real march the |n|−1 view reads flat zero and the live current-substep effort heatmap shows the march's per-pixel substep counts (REQ-TOOL-132).
