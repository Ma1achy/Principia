...
- **`ICDescriptor`** (64 B — 12 × f32 plus explicit padding, R-86): `m0 m1 m2, q_mass, rho_mag, lambda_mag, rho_ratio, rho_angle, K_0, V_0, virial_ratio, r_min_pair_0`. `E₀` is derived (`K_0 + V_0`), not stored (R-86). Written once post-decode, pre-integration. What the IC *is*, vs. what the trajectory *did*.
