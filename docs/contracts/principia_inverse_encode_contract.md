...
| `system_image` | how the address map folds onto distinct systems — bijective, n-to-1 or ray-degenerate (`principia_chart_decoder_contract.md` Part 5; R-59 D5). For an n-to-1 chart (the shape sphere: 2-to-1 over the φ hemispheres), show the canonical half, or label the redundant one. |
