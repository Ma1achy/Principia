...
## The spec_sources findings copy
...
## Fold pending change 11 into the detectors
...
## DEBUG_MODE has no bits in QuadRequest.flags
...
## FULL_RETENTION has no markdown owner
...
## Fold R-15 and R-18 into the scheduler contract
